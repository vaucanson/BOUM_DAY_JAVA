   ...
   public static ShopHistoryPopUpFrame getInstance()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShopHistoryPopUpFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShopHistoryPopUpFrame().setVisible(true);
            }
        });
    }
